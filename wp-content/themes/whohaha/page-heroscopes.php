					...
					<div class="col-md-8 post-content">
						<div class="socials">
							<span class="social-icon">
								<a class="facebook" target="_blank" onclick="javascript:socialShare.share('facebook', 600, 600);return false;" href="https://www.facebook.com/sharer/sharer.php?s=100&u=<?php echo $pageUrl ?>/"><i class="fa fa-facebook" aria-hidden="true"></i></a>
							</span>
							<span class="social-icon">
								<a class="twitter" target="_blank" data-pagetitle="<?php echo $pageTitle ?>" onclick="javascript:socialShare.share('twitter', 550, 450);return false;" href="http://twitter.com/intent/tweet?status=<?php echo $pageTitle ?>+<?php echo $pageUrl; ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a>
							</span>
							<span class="social-icon">
								<a class="pinterest" target="_blank" data-pagetitle="<?php echo $pageTitle ?>" data-thumbnail="<?php echo $pageThumb[0] ?>" onclick="javascript:socialShare.share('pinterest', 750, 600);return false;" href="http://pinterest.com/pin/create/bookmarklet/?media=<?php echo $pageThumb[0] ?>&url=<?php echo $pageUrl ?>&is_video=false&description=<?php echo $pageTitle ?>"><i class="fa fa-pinterest-p" aria-hidden="true"></i></a>
							</span>
						</div>
