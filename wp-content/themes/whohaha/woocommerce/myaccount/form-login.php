...
<div class="row">
	<div class="col-sm-8 col-md-6 col-lg-4 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
		...
		<?php endif; ?>
				...
				<h2 class="text-center login"><?php _e( 'Login', 'woocommerce' ); ?></h2>
				...
				<form method="post" class="login">
					...
					<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
						...
						<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" placeholder="Username or email address" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
					</p>
					<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
