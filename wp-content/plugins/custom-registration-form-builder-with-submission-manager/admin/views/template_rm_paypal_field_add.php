...
$form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_SELECT_TYPE') . ":</b>", "type", $price_field_type, array("value" => $data->selected_field, "id"=>"id_paypal_field_type_dd", "required" => "1", "onchange" => "rm_toggle_visiblity_pricing_fields(this)", "longDesc"=>RM_UI_Strings::get('HELP_ADD_PRICE_FIELD_SELECT_TYPE'))));
$form->addElement(new Element_Textbox("<b>" . RM_UI_Strings::get('LABEL_LABEL') . ":</b>", "name", array("id"=>"id_paypal_field_name_tb", /*"required" => "0",*/  "required" => "1", "value" => $data->model->name, "longDesc"=>RM_UI_Strings::get('HELP_ADD_PRICE_FIELD_LABEL'))));
...
$form->addElement(new Element_Checkbox("<b>" . RM_UI_Strings::get('LABEL_SHOW_ON_FORM') . ":</b>", "show_on_form", array(1 => ""), array("id"=>"id_paypal_field_visible_cb",  "value" => $data->show_on_form)));
...
?>
    ...
    <div class="rm-upgrade-note-gold">
        <div class="rm-banner-title">Unlock multiple pricing configurations by upgrading<img src="<?php echo RM_IMG_URL.'logo.png'?>"> </div>
