    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            <ul>
                ...
                <li onclick="jQuery.rm_do_action('rm_user_role_mananger_form','rm_user_role_delete')"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get('LABEL_REMOVE'); ?></a></li>
            </ul>
        </div>
            ...
            foreach ($data->roles->custom as $role => $role_name)
            {
                ...
                <li id="<?php echo $role;?>">
                    <div class="rm-slab">
                        ...
                        <div class="rm-slab-content">
                            <input type="checkbox" name="rm_roles[]" value="<?php echo $role; ?>" id="checkbox_<?php echo $role; ?>">
                            <span><?php echo $role; ?></span>
                            <span><?php echo $role_name; ?></span>
